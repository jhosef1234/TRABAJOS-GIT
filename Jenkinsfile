        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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	', url: 'https://github.com/jhosef1234/TRABAJOS-GIT.git'
                }
            }
        }
        stage('Build') {
